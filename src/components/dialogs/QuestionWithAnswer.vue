  ...
  <q-dialog ref="dialogRef" @hide="onDialogHide" persistent>
    <q-card v-bind="$theme.card" style="max-width: 420px" class="full-width">
      ...
      <q-card-section class="column items-center">
        <span
          class="q-mt-sm q-mx-md text-center"
          v-html="$props.message"
        ></span>
        <q-form
          class="full-width q-mt-md"
          id="answer-form"
          @submit="onDialogOK(model)"
        >
          <q-input
      ...
      <q-card-section
        class="q-pt-none action-buttons"
        :class="{ reverse: $props.reverseActions }"
      >
        <q-btn
...
import type { IQuestionWithAnswerProps } from "src/types/IQuestion";
